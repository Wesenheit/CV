...
Working in the D\&E department on machine learning solutions for diagnosing degradation in NXE lithography machines (various contaminations in the optical column).
\begin{itemize}
    ...
    \item Implemented Bayesian inference algorithms to infer contamination profiles in the machines based on the hybrid models. Methods used: Variational Inference,
    Normalizing flows, Variational Autoencoders.
    ...
    \item Resulting method is considered for the production use with estimated cost-savings on order of $>20 \textrm{m \euro}$ per year.
\end{itemize}
...
Project in cooperation with Bart Ripperda (CITA, Toronto), Alexander Philippov (University of Maryland/Stanford University) and Agnieszka Janiuk (CFT, PAS).
\begin{itemize}
    \item Performing basic research in the field of the high energy astrophysics (plasma physics, physics of accretion).
    \item Analyzing data from various HPC simulations starting from small scale local simulations up to global simulations.
    \item Scientific code development, most of my work was centered around HPC visualization softwere that was used to analyze multi TB snapshots
    from the simulations.
    \item Performed work was presented in two second-author publications.
\end{itemize}

{\sl Student research assistant at Astronomical Observatory} \hfil July 2022 - July 2025\\
Student position in grant 2021/41/B/ST9/00252, working under the supervision of Przemysław Mróz.
\begin{itemize}
    \item Performing basic research in the field of the observational astrophysics. Results include two first-author and one contributing-author publications.
    \item Scientific code development, main activities include writing custom Bayesian inference software based on MCMC methods, analyzing various observational data
    from various scientific surveys/telescopes including OGLE, Gaia, HST and more.
    \item Scientific topics: Microlensing, binary stars.
\end{itemize}
\begin{comment}
{\sl Student research assistant, Nicolaus Copernicus Astronomical Center} \hfill April 2023 - July 2025\\
Working under supervision of Krzysztof Nalewajko (NCAC).
...
\section{PUBLICATIONS}
    \begin{itemize}
        \item K.Nalewajko, \textbf{M.Kapusta}, B.Ripperda, A.Phillipov. "Distortion of a relativistic jet echoing a magnetic flux eruption"
        Submitted in Astrophysical Journal
